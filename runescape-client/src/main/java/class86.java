...
public class class86 {
	...
	static int method473(int var0, int var1) {
		...
		if (var2 == null) {
			...
			if (var2.secondaryRgb >= 0) {
				var6 = ClientPreferences.method551(var2.secondaryHue, var2.secondarySaturation, var2.secondaryLightness);
				var5 = class219.method1131(var6, 96);
				return Rasterizer3D.Rasterizer3D_colorPalette[var5] | -16777216;
			} else if (var2.texture >= 0) {
				var6 = class219.method1131(Rasterizer3D.clips.Rasterizer3D_textureLoader.getAverageTextureRGB(var2.texture), 96);
				return Rasterizer3D.Rasterizer3D_colorPalette[var6] | -16777216;
			} else if (var2.primaryRgb == 16711935) {
				return var1;
			} else {
				var6 = ClientPreferences.method551(var2.hue, var2.saturation, var2.lightness);
				var5 = class219.method1131(var6, 96);
				return Rasterizer3D.Rasterizer3D_colorPalette[var5] | -16777216;
			}
		}
	...
	public static int method474(int var0) {
		return GrandExchangeOfferAgeComparator.method2033(ViewportMouse.ViewportMouse_entityTags[var0]);
	}
}
