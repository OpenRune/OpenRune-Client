...
public class GraphicsObject extends Renderable {
	...
	final void advance(int var1) {
		if (!this.isFinished) {
			...
			if (!this.sequenceDefinition.isCachedModelIdSet()) {
				...
				this.frame += var1;
				if (this.frame >= this.sequenceDefinition.method1073()) {
					this.isFinished = true;
				}
			}
	...
	static void method426(SequenceDefinition var0, int var1, int var2, int var3, Actor var4) {
		if (Client.soundEffectCount < 50) {
			if (var0.soundEffects != null && var1 < var0.soundEffects.length && var0.soundEffects[var1] != null) {
				...
				if ((var5 <= 0 || class30.clientPreferences.getAreaSoundEffectsVolume() != 0) && (var5 != 0 || class30.clientPreferences.getSoundEffectsVolume() != 0)) {
					class94.method520(var0.soundEffects[var1], var2, var3, var4 == VarpDefinition.localPlayer);
				}
			}
		}
	}
	...
	static void method427(int var0, int var1, int var2, int var3, int var4, int var5) {
