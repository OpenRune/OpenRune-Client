...
public class InvDefinition extends DualNode {
	...
	static void method891(int var0) {
		...
		if (var1.isCachedModelIdSet()) {
			...
			if (var5 != null) {
				...
				var5 = class93.method509(class135.SequenceDefinition_animationsArchive, class138.SequenceDefinition_skeletonsArchive, var3, false);
				if (var5 != null) {
			...
			if (var4 == null) {
				...
				var2 = var4.method754() ? 0 : 1;
			}

			if (var2 == 2) {
				Client.field635.add(var1.SequenceDefinition_cachedModelId);
			}
