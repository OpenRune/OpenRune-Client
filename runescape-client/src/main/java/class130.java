...
public enum class130 implements Enum {
	...
	public static void method717(int var0, int var1) {
	...
	public static int method719(CharSequence var0) {
	...
	public static boolean method720(AbstractArchive var0, int var1, int var2) {
